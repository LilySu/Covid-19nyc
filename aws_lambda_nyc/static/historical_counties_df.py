...
def wrangle_historical_nyc_df():
    """ This function is only here just in case there needs to be 
    manual adjustment of historical data prior to April 10. 
    Returns df """
    ...
    # df4_19 = pd.read_csv('https://raw.githubusercontent.com/nychealth/coronavirus-data/master/boro.csv')
