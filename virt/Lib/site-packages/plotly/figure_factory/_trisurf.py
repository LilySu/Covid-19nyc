...
def create_trisurf(
    ...
    >>> # Create a figure
    >>> fig_map_top_center = create_trisurf(x=x, y=y, z=z, colormap="Rainbow",
    ...                       simplices=simplices)
    ...
    >>> # Create a figure
    >>> fig_map_top_center = create_trisurf(x=x, y=y, z=z, colormap="Viridis",
    ...                       simplices=simplices)
    ...
    >>> # Create a figure
    >>> fig_map_top_center = create_trisurf(x=x, y=y, z=z, colormap=[(0.2, 0.4, 0.6), (1, 1, 1)],
    ...                       simplices=simplices)
    ...
    >>> # Create a figure
    >>> fig_map_top_center = create_trisurf(x=x, y=y, z=z,
