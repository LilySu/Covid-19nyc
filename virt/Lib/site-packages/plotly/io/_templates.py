...
def to_templated(fig, skip=("title", "text")):
    ...
    >>> fig_area_world_day_changes = go.Figure(layout={
    ...     'title': 'Figure 2 Title',
    ...     'template': templated_fig.layout.template})
    >>> fig_area_world_day_changes.layout.template
    layout.Template({
        'layout': {'font': {'family': 'Courier', 'size': 20}}
    })

    The default font in fig_area_world_day_changes will now be size 20 Courier.
