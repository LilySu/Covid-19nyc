...
def get_plotlyjs():
    ...
    >>> fig_map_top_center = go.Figure(data=[{'type': 'bar', 'y': [1, 3, 2]}],
    ...                 layout={'height': 400})
    >>> fig_area_world_day_changes = go.Figure(data=[{'type': 'scatter', 'y': [1, 3, 2]}],
    ...                  layout={'height': 400})
    >>> div1 = plot(fig_map_top_center, output_type='div', include_plotlyjs=False)
    >>> div2 = plot(fig_area_world_day_changes, output_type='div', include_plotlyjs=False)
